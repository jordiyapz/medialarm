  ...
  useEffect(() => {
    if (!isReady) {
      confirm({
        ...
        description: "In order that this application can play the alarm sound you must permit it to play audio.",
        ...
        .catch(() => {
          confirm({
            ...
            description: "Please enable audio playback anytime from the button below to the left. Have a good day!",
